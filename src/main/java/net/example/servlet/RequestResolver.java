...
public class RequestResolver {
    ...
    public RequestResolver(WelcomeController welcomeController, UserController userController, GroupController groupController, UserTransformer userTransformer) {
